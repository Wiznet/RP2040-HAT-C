...
7. If the MQTT Publish & Subscribe example works normally on Raspberry Pi Pico or W5100S-EVB-Pico, you can see the network information of Raspberry Pi Pico or W5100S-EVB-Pico, connecting to the broker, subscribing to the subscribe topic and publishing the message.
